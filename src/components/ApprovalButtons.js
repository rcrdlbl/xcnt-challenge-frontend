...
const ApprovalButtons = ({ approved, id, updateApproved }) => {
    ...
    return (
      <ButtonGroup>
        <UndoButton
          onClick={e => {
            e.preventDefault();
            updateApproved({ variables: { approved: !approved, id } });
          }}
        >
...
<Icon icon={cross} />
      ...
      <ApproveButton
        onClick={e => {
          e.preventDefault();
          updateApproved({ variables: { approved: true, id } });
        }}
      >
        Approve 
{' '}
